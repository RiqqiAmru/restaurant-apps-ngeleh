...
class FavoriteButtonHomeInitiator {
  ...
  _renderLike() {
    ...
    <img src="./images/icons/bookmarks.svg" alt="Tambah ke Favorite" width="30" height="30" />
    </button>
    `;
  ...
  _renderLiked() {
    ...
    <img src="./images/icons/bookmarks-fill.svg" alt="Hapus dari  Favorite" width="30" height="30" />
    </button>
    `;
